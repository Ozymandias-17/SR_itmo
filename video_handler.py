...
def photos_to_video(video_path, original_fps, upscaled_frames_folder=OUTPUT_FOLDER):
    
    all_frames = sorted(glob.glob(os.path.join(upscaled_frames_folder, "*.png")))
...
def cleanup_folders():
    ...
    """
    folders_to_clean = [INPUT_FOLDER, OUTPUT_FOLDER, UPSCALED_FRAMES]
